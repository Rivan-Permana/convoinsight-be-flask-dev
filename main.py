...
# - Manipulator/Visualizer/Analyzer use pai.DataFrame wrappers on Polars
...
def upload_dataset_file(file_storage, *, domain: str) -> dict:
    ...
    - If GCS upload/meta fails (or not set) → automatically fall back to local save.
    """
    if not GCS_BUCKET:
...
# =========================
# Latest Pipeline Configs (a0.0.8)
# =========================

# --- HTML ENFORCER (from a0.0.8) ---
...
# =========================
# Query/Inferencing Endpoint (a0.0.8 configs)
# =========================
@app.post("/query")
def query():
    """
